...
public class HomeScreenController implements Initializable {
    ...
    public void refreshAppointmentAlert() {
        ...
        if (upcomingAppointment != null) {
            appointmentAlertLabel.setText("Upcoming appt ID: " + upcomingAppointment.getAppointmentId() + " at: " + AppointmentTimeChecker.convertUTCToLocal(upcomingAppointment.getStartDateTime()));
        }
        else {
